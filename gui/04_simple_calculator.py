...
#    Updated: 2021/08/07 23:22:59 by lamorim          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def button_click(nbr):
    ...
    myEntry.insert(0, str(current) + str(nbr))
...
def button_equal():
    ...
    s_nbr = int(second_number)
    myEntry.delete(0, END)

    if op == 'add':
        myEntry.insert(0, f_nbr + s_nbr)
    if op == 'sub':
        myEntry.insert(0, f_nbr - s_nbr)
    if op == 'mul':
        myEntry.insert(0, f_nbr * s_nbr)
